...
const char* ssid = "gohappygo"; // The SSID (name) of the Wi-Fi network you want to connect to
const char* pass = "Dayt0n1!"; // The password of the Wi-Fi network
const char* auth = "GSMKa4VEDYlTfayXpn6IaiGzNGFKfJlY"; //The Blynk Authorization Token
